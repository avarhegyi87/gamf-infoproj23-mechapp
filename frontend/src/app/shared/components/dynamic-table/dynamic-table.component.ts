import { Component, Input, OnInit, DoCheck , ViewChild, SimpleChanges, OnChanges} from '@angular/core';
...
export class DynamicTableComponent implements OnInit, OnChanges   {
  ...
  this.dataSource = new MatTableDataSource((this.tableForm.get('tableArray') as FormArray).controls);
